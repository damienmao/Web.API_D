...
public class SecondCryptoCurrencyOutput extends Generic {
    private String id;
    ...
    public SecondCryptoCurrencyOutput (SecondCryptoCurrencyOutputBuilder secondCryptoCurrencyOutputBuilder){
        ...
        current_price= secondCryptoCurrencyOutputBuilder.current_price;
        market_cap= secondCryptoCurrencyOutputBuilder.market_cap;
    }
